      ...
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-450">
            Sign up to deploy automated web tasks and track submissions
          </p>
        </div>
        ...
        {success && (
          <Alert className="bg-emerald-50 border-emerald-200 text-emerald-800 dark:bg-emerald-950/20 dark:border-emerald-900/50 dark:text-emerald-450">
            <CheckCircle2 className="h-4 w-4 text-emerald-600 dark:text-emerald-500" />
            <AlertTitle className="text-xs font-semibold">Registered Successfully</AlertTitle>
        ...
        <Card className="border-zinc-200/80 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Enter details below to create your profile</CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="text-center text-xs text-zinc-550 dark:text-zinc-400">
                ...
                <Link href="/login" className="font-semibold text-violet-650 hover:underline dark:text-violet-400">
                  Sign in
                </Link>
              </div>
            </CardFooter>
